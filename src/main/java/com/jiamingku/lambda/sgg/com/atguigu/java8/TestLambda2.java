...
//		strs = {"aaa", "bbb", "ccc"};
    ...
    public void test5() {
        ...
        show(hashMap);
        Map<Object, Object> ooo;
        // show(new HashMap<Object, Object>());//编译错误
        // show(ooo); //这个也是错误的
    }
    ...
    public void ttt() {
        ...
        Function<Integer, String> f2 = (x) -> x + 100 + "";
        String i = f1.andThen(f2).apply("11111");
    ...
    public void test6() {
        ...
        // 类型推断。lambda表达式允许我们通过接口来引用一个函数式接口
        String name = ((MyFun1) x -> x + 1).getName();
