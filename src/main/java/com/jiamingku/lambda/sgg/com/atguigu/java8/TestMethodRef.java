...
//         System.out.println(sup3.get());
    ...
    // 对象的引用 :: 实例方法名
    // Function<String, String> upperfier = String::toUpperCase; 所有对象的实例方法
    ...
    public void test1() {
        ...
        String url = "";
        Predicate<String> predicate = (s) -> url.contains(s);
        predicate = url::contains;
    }


    public void ttt(String s, Predicate<String> predicate) {
        predicate.test(s);
    }
