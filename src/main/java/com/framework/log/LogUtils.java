...
public final class LogUtils {
    ...
    private static MsgAndArgs get(StackTraceElement[] trace, Boolean b, String msg, Object... args) {
        ...
        String me = LogUtils.class.getName();
        Object[] newArr = new Object[args.length + 3];
        int line = -1;
        String className = "";
        for (int i = 0, len = trace.length - 1; i < len; i++) {
            if (trace[i].getClassName().equals(me)) {
        ...
        newArr[1] = line;
        newArr[2] = "8260";
        System.arraycopy(args, 0, newArr, 3, args.length);
        return new MsgAndArgs("Class: {}, Line {}, OrderCode {}: " + msg + (b == null ? "" : b.booleanValue() ? " (^-^)" : " (x_x)"), newArr);
    }
